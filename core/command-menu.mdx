...
<Container>
  <div className="flex gap-2">
    <div
      className="rounded-full border border-orange-400 text-neutral-900 font-small w-fit flex items-center"
      style={{ height: '28px', padding: '0 12px' }}
    >
      transactions
    </div>
    <div
      className="rounded-full border border-green-400 text-neutral-900 font-small w-fit flex items-center"
      style={{ height: '28px', padding: '0 12px' }}
    >
      addresses
    </div>
    <div
      className="rounded-full border border-blue-400 text-neutral-900 font-small w-fit flex items-center"
      style={{ height: '28px', padding: '0 12px' }}
    >
      assets
    </div>
    <div
      className="rounded-full border border-purple-400 text-neutral-900 font-small w-fit flex items-center"
      style={{ height: '28px', padding: '0 12px' }}
    >
      blocks
    </div>
